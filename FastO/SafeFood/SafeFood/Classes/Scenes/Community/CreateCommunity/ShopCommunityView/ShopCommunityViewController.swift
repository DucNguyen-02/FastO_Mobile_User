//
//  ShopCommunityViewController.swift
//  SafeFood
//
...
final class ShopCommunityViewController: BaseViewController {
    ...
    private lazy var presenter: ShopCommunityPresenter = {
      let presenter = ShopCommunityPresenter()
      presenter.view = self
      return presenter
    }()
...
private extension ShopCommunityViewController {
    func setupUI() {
...
extension ShopCommunityViewController: UICollectionViewDataSource {
...
extension ShopCommunityViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        delegate?.chooseShop(brand: presenter.brands[indexPath.row])
        dismiss(animated: true)
    }
}
...
extension ShopCommunityViewController: UICollectionViewDelegateFlowLayout {
...
// MARK: - ShopCommunityViewInput

extension ShopCommunityViewController: ShopCommunityViewInput {
